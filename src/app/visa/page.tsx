...
const VisaPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact">
                <motion.button
                  ...
                  className="bg-yellow-400 text-purple-900 px-6 py-3 md:px-8 md:py-4 rounded-lg font-semibold text-base md:text-lg flex items-center justify-center hover:bg-yellow-300 transition-colors whitespace-nowrap"
                >
              ...
              <Link href="#visa-requirements">
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  className="border-2 border-white text-white px-6 py-3 md:px-8 md:py-4 rounded-lg font-semibold text-base md:text-lg flex items-center justify-center hover:bg-white hover:text-purple-800 transition-colors whitespace-nowrap"
                >
                  <span className="flex items-center space-x-2">
                    <FileText size={20} />
      ...
      <section id="visa-requirements" className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/education">
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  className="border-2 border-white text-white px-6 py-3 md:px-8 md:py-4 rounded-lg font-semibold text-base md:text-lg flex items-center justify-center hover:bg-white hover:text-purple-600 transition-colors whitespace-nowrap"
                >
                  <span className="flex items-center space-x-2">
